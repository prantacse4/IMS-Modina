...
@include('admin.pages.dealer.sidebar.adddealersidebar')
@endsection
                            ...
                            <!-- /.card -->
                                ...
                                <div class="container-fluid">
                                    ...
                                    <!-- Horizontal Form -->
                                        ...
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form  class="form-horizontal" action="{{ route('admin.adddealer.store') }}" method="POST" >
                                            @csrf
                                            <div class="card-body">
                                                <x-alert></x-alert>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                <input  type="text" name="name" class="form-control" placeholder="Enter dealer Name" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                <input type="text" name="address" class="form-control" placeholder="dealer Local Address" required>
                                                </div>
                                            </div>
