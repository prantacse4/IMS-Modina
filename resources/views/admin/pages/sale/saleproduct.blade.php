@extends('admin.pages.sale.layouts.saleproductlayout')
    ...
    <div class="container-fluid">
                        ...
                        <div class="mr-auto p-2">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><input type="datetime-local" value="{{Carbon\Carbon::now()->format('Y-m-d')."T".Carbon\Carbon::now()->format('H:i')}}" class="form-control" id="saleDate"  ></td>
                                </tr>
        ...
        <div class="contents card">
            <div class="card-header bg-primary">
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="m-0">Add Product to Sale</h5>
                    </div>
                    <div class="col-md-6  text-right">
                        ...
                        <span>
                            <a href="{{  route('admin.selectcompany') }}" class="btn btn-warning addbtn ml-2">Change Company</a>
                        </span>
                    </div>
                </div>
            </div>
...
$.ajax({
        ...
        $.each(data,function (key,value) {
                ...
                // Delete
                $.ajax({
                    url: urlHeader+'/api/admin/getTempSaleProduct/delete/'+database_product_id,
                    type: "delete",
                    dataType: "json",
...
$.ajax({
       ...
       // Setting ProductDetails Value 0 When Product is not Selected
        ...
        if(pro_id>0){
            ...
            success:function(data)
            {
                ...
                pro_selling = data[0].pro_selling;
    ...
    if(product_id>0 && qty>0 && can_add==true){
        ...
        // Saving Data
        $.ajax({
                    url : urlHeader+'/api/admin/postProductDetails/save',
                    type : "POST",
                    data : {
...
//Delete Row from Temp table
    ...
    $('#showtempproduct').on('click', '.delete_temp_product', function () {
        ...
        $.ajax({
            url: urlHeader+"/admin/getTempProductID/"+temproid,
            type: "GET",
            dataType: "json",
            success: function (data) {
...
// $("#saleDate").val(new Date().toDateString());
...
var saveDatabase = [{}];
$.ajax({
        url: urlHeader+"/admin/getLatestSavedID",
        type: "GET",
        dataType: "json",
        async: false,
        success: function (data) {
...
$('#finalSubmit').on('click', function(){
    ...
    if (data==false) {
        ...
        var save_fullData = {date:saleDate, company:com_id, dealer:dealer_id, showroom:showroom_id, total_amount:total_Payment };
    // Saving Data
    if (data==true) {
        $.ajax({
            url : urlHeader+'/api/admin/saveSaleRecords/save',
            type : "POST",
            async: false,
            data : save_fullData,
            success:function(data)
    ...
    $.ajax({
        url : urlHeader+'/admin/getTempSaleProduct',
        type: "GET",
        dataType : "json",
        async: false,
        success: function (data) {
            $.each(data,function (key,value) {
                    ...
                    var qty = value.qty;
                    var free = value.free;
                    var pro_sell = value.pro_sell;
                    var total = value.total;


                    // Save Data to New Table
                    $.ajax({
                        url: urlHeader+"/api/admin/saveSoldData/save",
                        type: "POST",
                        dataType: "json",
                        data:{
                            product_id:product_id,
                            sale_id:latestsavedID,
                            product_name:product_name,
                            qty:qty,
                            free:free,
                            pro_sell:pro_sell,
                        ...
                        success: function (response) {
                            ...
                            window.location.replace(urlHeader+"/admin/sale");
