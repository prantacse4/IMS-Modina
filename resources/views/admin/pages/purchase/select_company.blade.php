...
deletestatus =true;
$.ajax({
        url : '/admin/gettemp/purchasecondition',
        type : "GET",
        dataType : "json",
        ...
        $.each(data,function (key,value) {
                ...
                // Delete
                $.ajax({
                    url: urlHeader+'/api/admin/purchasecondition/delete/'+database_id,
                    type: "delete",
                    dataType: "json",
...
$.ajax({
    ...
    $.ajax({
        type: "POST",
        url: urlHeader+"/api/post/purchase/condition",
        data:{
            com_id:com_id
        },
        success: function (response) {
                var url = "{{ route('admin.purchaseproduct') }}";
