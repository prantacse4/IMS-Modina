                            ...
                            <!-- /.card -->
                                ...
                                <div class="container-fluid">
                                    ...
                                    <!-- Horizontal Form -->
                                        ...
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form  class="form-horizontal" action="{{ route('admin.updatecategory.update',$category[0]->id) }}" method="POST" >
                                            @csrf
                                            @method('PUT')
                                            <div class="card-body">
                                                <x-alert></x-alert>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                <input  type="text" name="cat_name" value="{{ $category[0]->cat_name }}" class="form-control" placeholder="Enter Category" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                <input type="text" name="cat_description" class="form-control" value="{{ $category[0]->cat_description }}" placeholder="Description about category" required>
                                                </div>
                                            </div>
